...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Closure, Code, Comment, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, compact, del, ends, extend, flatten, g_has_uwsc_result, last, merge, multident, my_show_dimension, some, starts, unfoldSoak, utility, _ref, _ref1,
  ...
  my_show_dimension = function(dimension, o) {
    var code, d, n, _i, _len;
    code = '';
    if (dimension) {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.cache = function(o, level, reused) {
      ...
      if (!this.isComplex()) {
        ...
        ref = new Literal(reused || o.scope.freeVariable('ref', false));
        v = ref = level ? this.compile(o, level) : this;
        return [v, ref];
      }
    };
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileNode = function(o) {
      var code, codes, is_comment, node, top, _i, _len, _ref2;
      this.tab = o.indent;
  ...
  exports.Return = Return = (function(_super) {
    ...
    Return.prototype.compileNode = function(o) {
      return this.tab + ("" + [this.expression ? "" + (this.expression.compile(o, LEVEL_PAREN)) : void 0]);
    };
  ...
  exports.Call = Call = (function(_super) {
    ...
    Call.prototype.compileNode = function(o) {
      var arg, args, code, fname, fnameUpper, _ref2;
      ...
      if (this.isSuper) {
        ...
        fname = this.variable.compile(o, LEVEL_ACCESS);
        fnameUpper = fname.toUpperCase();
        if (fnameUpper === 'PRINT') {
          return "PRINT " + args;
        } else if (fnameUpper === 'OPTION') {
          return "OPTION " + args;
        } else if (fnameUpper === 'CALL') {
          return "CALL " + args;
        } else if (fnameUpper === 'HASHTBL') {
          return "HashTbl " + args;
        } else {
          return (this.isNew ? 'new ' : '') + ("" + fname + "(" + args + ")");
        }
      }
    };
  ...
  exports.Range = Range = (function(_super) {
    ...
    Range.prototype.compileNode = function(o) {
      ...
      varPart = '';
      if (this.equals === '') {
        varPart = "" + idxName + " = " + this.fromC + " To " + this.toC + " - 1";
      } else {
        varPart = "" + idxName + " = " + this.fromC + " To " + this.toC;
      }
      if (this.stepVar) {
        varPart += " Step " + this.step;
      }
      return varPart;
  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.compileNode = function(o) {
      var call, decl, lname, name, params, ret, _ref2;
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    function Assign(variable, value, context, options) {
      ...
      if (options && options['const'] === true) {
        this.is_const = true;
      }
      if (options && options['public'] === true) {
        this.is_public = true;
      }
      if (options && options['dim'] === true) {
        this.is_dim = true;
      }
    ...
    Assign.prototype.compileNode = function(o) {
      var identify, isValue, match, name, val, value_str, varBase, _ref2, _ref3, _ref4, _ref5;
      ...
      identify = name = this.variable.compile(o, LEVEL_LIST);
      if (this.dimension) {
        name += my_show_dimension(this.dimension, o);
      }
      if (!this.context) {
          ...
          if (this.param) {
            ...
            if (name.toUpperCase() === 'RESULT') {
              ...
              if (o.scope.is_const(name)) {
                throw new SyntaxError("re-assignment to const : " + name + " = " + (o.scope.get_const_val(name)) + " to " + (this.value.compile(o)));
              }
              if (!o.scope.is_public(name)) {
                o.scope.find(name);
              }
            }
          }
      ...
      value_str = void 0;
      if (this.value) {
        val = value_str = this.value.compile(o, LEVEL_LIST);
      }
      if (this.is_dim && val && val.length > 1) {
        if (this.dimension) {
          val = val.slice(1, +(val.length - 2) + 1 || 9e9);
        } else if ((val.length > 1) && (val[0] === '[') && (val[val.length - 1] === ']')) {
          name += '[]';
          val = val.slice(1, +(val.length - 2) + 1 || 9e9);
        }
      }
      ...
      if ((this.value === void 0) || ("" + this.value.bound) === "undefined") {
        if (this.value && val.length > 0) {
          val = name + (" " + (this.context || '=') + " ") + val;
        } else {
          val = name;
        }
        if (this.is_dim && (this.is_const === void 0) && (this.is_public === void 0)) {
          val = 'DIM ' + val;
        }
        if (this.is_const) {
          val = 'CONST ' + val;
        }
        if (this.is_public && !this.is_const) {
          val = 'PUBLIC ' + val;
        }
        if (this.is_const) {
          o.scope.set_const_val(name, value_str);
        }
      } else {
    ...
    Assign.prototype.compilePatternMatch = function(o) {
      var acc, assigns, code, i, idx, isObject, ivar, name, obj, objects, olen, ref, rest, splat, top, val, value, vvar, _i, _len, _ref2, _ref3, _ref4;
      top = o.level === LEVEL_TOP;
      value = this.value;
      ...
      if (vvar && vvar.length > 2) {
        vvar = vvar.slice(1, +(vvar.length - 2) + 1 || 9e9);
      }
      assigns = [];
      splat = false;
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var code, exprs, i, idt, name, p, param, params, ref, splats, uniqs, val, wasEmpty, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
  ...
  exports.Param = Param = (function(_super) {
    ...
    function Param(name, value, splat, is_var, dimension) {
      var _ref2;
      this.name = name;
      this.value = value;
      this.splat = splat;
    ...
    Param.prototype.compile = function(o) {
      ...
      code = code + my_show_dimension(this.dimension, o);
      return code;
    };
  ...
  exports.While = While = (function(_super) {
    ...
    While.prototype.compileNode = function(o) {
      ...
      code = set + this.tab + ("While (" + (this.condition.compile(o, LEVEL_PAREN)) + ")" + body + "Wend");
      if (this.returns) {
        code += "\n" + this.tab + rvar;
      }
      return code;
  ...
  exports.Op = Op = (function(_super) {
    ...
    Op.prototype.compileChain = function(o) {
      ...
      code = "" + fst + " " + (this.invert ? 'and' : 'or') + " " + (shared.compile(o)) + " " + this.operator + " " + (this.second.compile(o, LEVEL_OP));
      return "(" + code + ")";
    };
  ...
  exports.For = For = (function(_super) {
    ...
    For.prototype.compileNode = function(o) {
      var body, defPart, forPart, guardPart, idt1, index, ivar, kvar, lastJumps, name, namePart, ref, resultPart, returnResult, scope, source, stepPart, stepvar, svar, varPart, _ref2;
      ...
      ivar = this.range || scope.freeVariable('i');
      ...
      if (this.range) {
        ...
        if (!this.object) {
          stepPart = this.step ? "Step " + (this.step.compile(o, LEVEL_OP)) : "";
      ...
      return "" + defPart + (resultPart || '') + this.tab + "For " + forPart + guardPart + varPart + body + this.tab + "Next" + (returnResult || '');
    };
  ...
  exports.Switch = Switch = (function(_super) {
    ...
    Switch.prototype.compileNode = function(o) {
      ...
      code = this.tab + ("Select (" + (((_ref2 = this.subject) != null ? _ref2.compile(o, LEVEL_PAREN) : void 0) || false) + ")\n");
      _ref3 = this.cases;
  ...
  multident = function(code, tab) {
    var ans, line, line_idx, lines, lines_last_idx, _i, _len;
    code = code.replace(/^\n/, '');
    code = code.replace(/\n. $/, '');
    code = code.replace(/\n$/, '');
    ans = '';

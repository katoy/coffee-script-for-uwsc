...
(function() {
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.compileNode = function(o) {
      var isValue, match, name, val, value_str, varBase, _ref2, _ref3, _ref4, _ref5;
      ...
      if ((this.value === void 0) || ("" + this.value.bound) === "undefined") {
        ...
        if (this.is_const && value_str) {
          o.scope.set_const_val(name, value_str);
        }
        if (this.is_public && value_str) {
          o.scope.set_public_val(name, value_str);
        }
      } else {
  ...
  exports.Param = Param = (function(_super) {
    ...
    function Param(name, value, splat, is_var, is_array) {
      var _ref2;
      this.name = name;
      this.value = value;
      this.splat = splat;
    ...
    Param.prototype.compile = function(o) {
      ...
      if (this.is_array) {
        code = code + this.is_array.compile(o);
      }
      return code;
    };
  ...
  exports.ArrayDims = ArrayDims = (function(_super) {

    __extends(ArrayDims, _super);

    function ArrayDims(dims) {
      this.dims = dims;
    }

    ArrayDims.prototype.children = ['dims'];

    ArrayDims.prototype.compileNode = function(o) {
      return this.dims;
    };

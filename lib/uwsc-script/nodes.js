...
(function() {
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.compileNode = function(o) {
      ...
      if (this.is_array && val && val.length > 1) {
        val = val.slice(1, +(val.length - 2) + 1 || 9e9);
      }
      if (this.is_array && name.lastIndexOf(']') !== name.length - 1) {
        name = name + '[]';
      }
  ...
  exports.Param = Param = (function(_super) {
    ...
    function Param(name, value, splat, is_var, dims) {
      var _ref2;
      this.name = name;
      this.value = value;
      this.splat = splat;
    ...
    Param.prototype.compile = function(o) {
      ...
      if (this.dims) {
        code = code + this.show_dims(this.dims, o);
      }
      return code;
    };

    Param.prototype.show_dims = function(dims, o) {

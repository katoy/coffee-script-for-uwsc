...
(function() {
  ...
  exports.Scope = Scope = (function() {
    ...
    Scope.prototype.set_public_val = function(name, val) {
      var v, _i, _len, _ref1;
      _ref1 = this.variables;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        v = _ref1[_i];
        if (!(v.name === name && (v.type = 'uwsc_public'))) {
          continue;
        }
        v._val = val;
        return;
      ...
      if (this.parent) {
        return this.parent.set_public_val(name);
      }
    };

    Scope.prototype.get_public_val = function(name) {
      var ans, v, _i, _len, _ref1;
      ans = void 0;
      _ref1 = this.variables;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
      ...
      if (this.parent) {
        return this.parent.get_public_val(name);
      }
      return void 0;
    };

...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.uwsc_string = function(doc) {
      if (doc) {
        doc = doc.replace(/\r\n/g, '<#CR>');
        doc = doc.replace(/\r|\n/g, '<#CR>');
    ...
    Lexer.prototype.literalToken = function() {
      ...
      if (value === '=' && prev) {
        ...
        if ((_ref3 = prev[1]) === '||' || _ref3 === '&&' || _ref3 === 'and' || _ref3 === 'or') {
  ...
  JS_KEYWORDS = ['true', 'false', 'null', 'this', 'new', 'delete', 'typeof', 'in', 'instanceof', 'return', 'throw', 'break', 'continue', 'debugger', 'if', 'else', 'switch', 'for', 'while', 'do', 'try', 'catch', 'finally', 'class', 'extends', 'super', 'const', 'public', 'var'];
  ...
  RESERVED = ['case', 'default', 'function', 'void', 'with', 'let', 'enum', 'export', 'import', 'native', '__hasProp', '__extends', '__slice', '__bind', '__indexOf', 'implements', 'interface', 'package', 'private', 'protected', 'static', 'yield'];
